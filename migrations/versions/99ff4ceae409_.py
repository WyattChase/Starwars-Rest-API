...
Revision ID: 99ff4ceae409
Revises: 
Create Date: 2023-05-19 10:42:38.504266
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['favorite_people'], ['user_favs.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.ForeignKeyConstraint(['favorite_planets'], ['user_favs.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name')
    )
